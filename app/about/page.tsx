...
export const metadata = {
  title: "О заводе септиков «Мурзалёв» в Симферополе — производство и монтаж в Крыму",
  description:
    "Завод септиков Мурзалёв в Симферополе с 2014 года. 200+ установок по Крыму, 70+ моделей септиков, накопителей, кессонов и дренажных колодцев. Полный цикл — производство, доставка, монтаж под ключ за 1-5 дней.",
};
