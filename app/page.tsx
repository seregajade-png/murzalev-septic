        ...
        <Reveal>
          <div className="space-y-6">
            ...
            <p className="text-graphite-400 leading-relaxed">
              Производим септики, накопители, дренажные колодцы и кессоны на собственном заводе в Симферополе. Собственное производство в Крыму: здесь живём, здесь работаем, здесь отвечаем за результат.
            </p>
            <p className="text-graphite-400 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <a href={company.whatsapp} target="_blank" rel="noopener" className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-md text-white text-sm font-medium bg-[#25D366] hover:opacity-90 transition">
                ...
                <a href={company.telegram} target="_blank" rel="noopener" className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-md text-white text-sm font-medium bg-[#229ED9] hover:opacity-90 transition">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M9.036 16.57l-.396 3.958c.564 0 .81-.242 1.104-.532l2.648-2.525 5.487 4.017c1.006.554 1.715.263 1.987-.93l3.602-16.874c.32-1.492-.54-2.075-1.52-1.71L1.11 9.38c-1.459.566-1.437 1.376-.248 1.742l5.124 1.596L17.794 5.24c.56-.37 1.07-.165.65.204L9.036 16.57z"/></svg>
                  Telegram
                </a>
                <a href={company.max} target="_blank" rel="noopener" className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-md bg-white border border-graphite-200 text-graphite text-sm font-medium hover:bg-graphite-100 transition">
                  <svg width="16" height="16" viewBox="0 0 42 42" fill="#0077FF"><path fillRule="evenodd" d="M21.47 41.88c-4.11 0-6.02-.6-9.34-3-2.1 2.7-8.75 4.81-9.04 1.2 0-2.71-.6-5-1.28-7.5C1 29.5.08 26.07.08 21.1.08 9.23 9.82.3 21.36.3c11.55 0 20.6 9.37 20.6 20.91a20.6 20.6 0 0 1-20.49 20.67m.17-31.32c-5.62-.29-10 3.6-10.97 9.7-.8 5.05.62 11.2 1.83 11.52.58.14 2.04-1.04 2.95-1.95a10.4 10.4 0 0 0 5.08 1.81 10.7 10.7 0 0 0 11.19-9.97 10.7 10.7 0 0 0-10.08-11.1Z" clipRule="evenodd"/></svg>
                  MAX
                </a>
                <a href={company.avito} target="_blank" rel="noopener" className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-md bg-white border border-graphite-200 text-graphite text-sm font-medium hover:bg-graphite-100 transition">
                  <svg width="18" height="16" viewBox="0 0 420 380" fill="none">
