...
export const metadata = {
  title: "Каталог септиков, накопителей и колодцев в Крыму — цены от производителя",
  description: "70+ моделей септиков Экофильтр, накопителей, дренажных колодцев, кессонов и погребов. Собственный завод в Симферополе, доставка и монтаж по всему Крыму. Цены от производителя без посредников.",
};
            ...
            <div className="bg-forest text-cream p-8 md:p-10 flex flex-col justify-between gap-8 min-h-[400px]">
              ...
              <div className="space-y-3">
                ...
                <a
                  ...
                  className="flex items-center gap-3 bg-cream/95 hover:bg-cream text-graphite rounded-2xl px-5 py-3.5 transition"
                >
                  <span className="w-9 h-9 rounded-full bg-white border border-graphite-200 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 42 42" fill="#0077FF">
