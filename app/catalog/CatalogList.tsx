...
export function CatalogList() {
  ...
  return (
    <div>
      ...
      <div id="products-list" className="flex flex-wrap gap-2 mb-10 md:sticky md:top-20 bg-cream/95 backdrop-blur py-4 -mx-4 px-4 border-b border-graphite-200/40 z-10">
