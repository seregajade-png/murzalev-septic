...
export const categories: CategoryInfo[] = [
  ...
  },
  {
    ...
    descriptionFull:
      "Герметичная и надёжная ёмкость, предназначенная для хранения питьевой или технической воды. Подходит для частных домов, дач, предприятий и объектов, где требуется резервуар для запаса воды. Корпус выполнен из прочного первичного полипропилена, полностью безопасного для человека и окружающей среды. Может использоваться как резервуар для питьевой воды, технических нужд, полива участка или противопожарных запасов.",
    composition: [
      "**Герметичный корпус** — исключает утечки и защищает воду от загрязнений.",
      "**Заливной и выводной патрубки** — обеспечивают удобство эксплуатации.",
      "**Технологические люки** — для контроля, обслуживания и подключения оборудования.",
    ],
    advantages: [
      "**Прочный и долговечный корпус** из монолитного полипропилена. Не гниёт, не ржавеет, не подвергается коррозии",
      "**Герметичность и безопасность** — вода не контактирует с почвой и грунтовыми водами",
      "**Небольшой вес и простой монтаж** без применения спецтехники",
      "**Подходит для любых условий эксплуатации** и климата",
      "**Долгий срок службы** без потери прочности",
    ],
    included: [
      "**Ёмкость** заводской сборки в полной комплектации",
      "**Гарантия** от производителя «Мурзалёв» с сервисным обслуживанием",
      "**Бесплатная доставка** к вам на участок",
      "**Консультация инженера** по подбору и подключению",
      "Полный **пакет документов** при необходимости (для организаций)",
    ],
  ...
  },
  {
    ...
    descriptionFull:
      "Колодец дренажный предназначен для рассеивания стоков в инертном материале в почву. Колодец выполнен из прочного полипропилена, имеет по всему периметру перфорацию. Колодец лёгкий, прочный, его просто монтировать.",
  ...
  },
  {
    ...
    descriptionFull:
      "Готовый полипропиленовый погреб заводской сборки. Поставляется в полной комплектации — с утеплённой дверью входного люка, лестницей, готовыми полками, освещением и приточно-вытяжной вентиляцией. Поддерживает стабильную температуру и влажность круглый год, не требует дополнительной обработки.",
    composition: [
      "**Корпус** из полипропилена",
      "**Армированные рёбра жёсткости**",
      "**Дверь входного люка** (утеплённая)",
      "**Готовые полки** из полипропилена",
      "Удобная **деревянная лестница**",
      "**Яркое и экономное освещение**",
      "**Приточно-вытяжная вентиляция** (вентиляционная труба D=110)",
      "**Герметичный вывод** для эл. проводки (D=25)",
    ],
...
export const products: Product[] = [
  ...
  { slug: "nakopitel-10-alt", name: "Накопитель 10 м³ (удлинённый)", category: "nakopitel", price: 263200, size: "1910×3700 мм", weight: "364 кг", capacity: "10 м³", image: "/images/products/nakopitel.png" },
  ...
  { slug: "nakopitel-15-alt", name: "Накопитель 15 м³ (удлинённый)", category: "nakopitel", price: 372900, size: "1910×5500 мм", weight: "530 кг", capacity: "15 м³", image: "/images/products/nakopitel.png" },
